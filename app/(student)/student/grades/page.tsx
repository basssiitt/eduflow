    ...
    <div className="flex flex-col gap-6">
      <nav className="flex items-center justify-between text-xs text-slate-500 no-print">
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="gap-1.5 border-[#e7e2da] text-xs font-semibold hover:border-[#c5a059] hover:text-[#2c1d17] hover:bg-[#faf9f5]"
        >
      ...
      <div className="rounded-2xl border border-[#e7e2da] bg-white p-6 shadow-xs">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-[#e7e2da] pb-5">
          <div className="flex items-center gap-3.5">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-[#2c1d17] text-white shadow-xs">
              <GraduationCap className="size-6 text-[#c5a059]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <p className="text-2xl font-black text-[#2c1d17]">Grade A*</p>
            </div>
            <div className="h-9 w-px bg-[#e7e2da]" />
            <div className="text-right">
      ...
      <section className="rounded-2xl border border-[#e7e2da] bg-white shadow-xs overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="border-b border-[#e7e2da] bg-[#faf9f5] uppercase tracking-wider text-[#5c4a3e]">
              <tr>
            ...
            <tbody className="divide-y divide-[#e7e2da]">
              {subjects.map((s) => (
                <tr key={s.code} className="hover:bg-[#faf9f5] transition-colors">
                  ...
                  <td className="px-5 py-4 text-center">
                    <span className="inline-block rounded-md bg-[#faf9f5] border border-[#e7e2da] px-2 py-0.5 font-black text-[#2c1d17]">
                      {s.grade}
                    </span>
                  </td>
            ...
            <tfoot className="border-t-2 border-[#e7e2da] bg-[#faf9f5] font-bold">
              <tr>
                <td colSpan={5} className="px-5 py-3.5 text-[#5c4a3e]">Aggregate Total</td>
                <td className="px-5 py-3.5 text-center text-sm font-extrabold text-[#2c1d17]">
