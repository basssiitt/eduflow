    ...
    <div className="flex flex-col gap-6">
      <nav className="flex items-center justify-between text-xs text-slate-500">
        <div className="flex items-center gap-1.5 font-medium">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-slate-100 font-semibold">Homework &amp; Voice Diaries</span>
        </div>
      </nav>
            ...
            >
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-4 dark:border-slate-800">
                <div className="flex items-center gap-3">
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-sky-50 text-sky-600 dark:bg-sky-950 dark:text-sky-400">
                ...
                {item.audio_url && (
                  <Button
                    ...
                    className="gap-2 bg-sky-600 hover:bg-sky-700 text-white font-semibold shadow-xs"
                  >
