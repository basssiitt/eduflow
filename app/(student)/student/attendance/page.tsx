    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        <div className="rounded-2xl border border-[#e7e2da] bg-white p-5 shadow-xs">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#5c4a3e]">Term Attendance</span>
        ...
        <div className="rounded-2xl border border-[#e7e2da] bg-white p-5 shadow-xs">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#5c4a3e]">Days Present</span>
        ...
        <div className="rounded-2xl border border-[#e7e2da] bg-white p-5 shadow-xs">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#5c4a3e]">Days Absent</span>
          <p className="mt-3 text-3xl font-extrabold text-rose-600">{absentCount}</p>
          <p className="mt-1 text-xs text-slate-500">Unexcused</p>
        </div>
        <div className="rounded-2xl border border-[#e7e2da] bg-white p-5 shadow-xs">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#5c4a3e]">Approved Leaves</span>
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#e7e2da]">
                {attendanceList.map((row: any, idx: number) => {
                  ...
                  return (
                    <tr key={row.date || idx} className="hover:bg-[#faf9f5] transition-colors">
