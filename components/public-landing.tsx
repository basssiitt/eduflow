  ...
  return <main className="landing-page">
    <nav className="landing-nav">
      ...
      <div className="landing-links">
        <a href="#features" className="hover:text-blue-600 transition-colors">Why EduFlow</a>
        <a href="#pricing" className="hover:text-blue-600 transition-colors">Pricing</a>
        <a href="#faq" className="hover:text-blue-600 transition-colors">FAQ</a>
        <Link href="/login?next=/admin" className="hidden sm:inline-block text-xs font-semibold text-slate-700 hover:text-blue-600 transition-colors">Campus Admin</Link>
        <Link href="/login?next=/teacher" className="hidden sm:inline-block text-xs font-semibold text-slate-700 hover:text-blue-600 transition-colors">Teacher</Link>
        <Link href="/login?next=/parent" className="hidden sm:inline-block text-xs font-semibold text-slate-700 hover:text-blue-600 transition-colors">Parent</Link>
      </div>
      <div className="flex items-center gap-2">
        <Link className="text-xs font-semibold px-3 py-1.5 rounded-lg text-slate-700 hover:text-blue-600 dark:text-slate-200 transition-colors" href="/login?force=1">
          Sign In
        </Link>
