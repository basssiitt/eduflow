    ...
    <div className="space-y-6">
      <nav className="flex items-center justify-between text-xs text-slate-500 no-print">
        <div className="flex items-center gap-1.5 font-medium">
          ...
          <span>/</span>
          <span className="text-slate-900 font-semibold">WhatsApp Notification Center</span>
        </div>
      </nav>
      ...
      <header className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-extrabold tracking-tight text-slate-900">WhatsApp Notification Hub</h1>
          <p className="text-slate-500">Dispatch morning absentee haziri alerts, fee challan reminders, and official campus circulars.</p>
        </div>
        <Button
        ...
        <div className="space-y-5 lg:col-span-2">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-bold text-slate-900">1. Select Notification Template</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <button
                ...
                className={`p-3.5 rounded-xl border text-left transition ${
                  template === 'absent'
                    ? 'border-blue-500 bg-blue-50/60 text-slate-900 ring-1 ring-blue-500'
                    : 'border-slate-200 hover:bg-slate-50 text-slate-700'
                }`}
              >
                <div className="flex items-center justify-between">
                  <span className="font-bold text-xs">Morning Haziri Absent Alert</span>
                  <span className="text-[10px] font-semibold bg-rose-50 text-rose-700 px-1.5 py-0.5 rounded-xs">High Priority</span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-semibold bg-amber-50 text-amber-700 px-1.5 py-0.5 rounded-xs">Accounts</span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-semibold bg-orange-50 text-orange-700 border border-orange-200 px-1.5 py-0.5 rounded-xs">Emergency</span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-semibold bg-blue-50 text-blue-700 border border-blue-200 px-1.5 py-0.5 rounded-xs">Academics</span>
                </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-bold text-slate-900">2. Target Audience</h3>
              <span className="text-xs font-semibold text-blue-600">{targetList.length} Parents Selected</span>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold border transition ${
                  audience === 'absent' ? 'bg-blue-600 text-white border-blue-600' : 'border-slate-200 text-slate-700 hover:bg-slate-50 bg-white'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold border transition ${
                  audience === 'defaulters' ? 'bg-blue-600 text-white border-blue-600' : 'border-slate-200 text-slate-700 hover:bg-slate-50 bg-white'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold border transition ${
                  audience === 'class5' ? 'bg-blue-600 text-white border-blue-600' : 'border-slate-200 text-slate-700 hover:bg-slate-50 bg-white'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold border transition ${
                  audience === 'all' ? 'bg-blue-600 text-white border-blue-600' : 'border-slate-200 text-slate-700 hover:bg-slate-50 bg-white'
                }`}
              >
